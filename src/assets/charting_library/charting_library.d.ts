 ...
 */
export declare type CustomStudyFormatterFactory = (
...
export declare type LibrarySessionId =
  | 'regular'
  | 'extended'
  | 'premarket'
  | 'postmarket';
...
export declare type PlotShapeId =
  | 'shape_arrow_down'
  | 'shape_arrow_up'
  | 'shape_circle'
  | 'shape_cross'
...
export declare type SeriesFormatterFactory = (
  symbolInfo: LibrarySymbolInfo | null,
  minTick: string
...
export declare type SeriesPriceScale =
  ...
  | 'no-scale'
  | EntityId;
export declare type SeriesStatusViewSymbolTextSource =
  | 'ticker'
  | 'description'
...
export declare type StudyPlotInfo =
  | StudyArrowsPlotInfo
  | StudyCharsPlotInfo
  ...
  | StudyAlertConditionPlotInfo;
export declare type StudyPlotPreferences =
...
export declare type TimeframeOption =
  | string
  | {
      from: number;
      to: number;
...
export interface StudyBandStyle
  extends MappedObject<string | number | boolean> {
  color: string;
  linestyle: number;
  linewidth: number;
  value: number;
...
export interface StudyFilledAreaStyle
  extends MappedObject<string | number | boolean> {
  color: string;
  transparency: number;
  visible: boolean;
